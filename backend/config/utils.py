...
GAMES = [
    ...
    {"title": "Dark Dungeon", "type": "Рольові (RPG)", "genres": ["Детективи", "Фентезі"], "mechanics": ["Кидання кубиків"]},
    ...
    {"title": "Galactic Empires", "type": "Стратегічні", "genres": ["Жахи", "Детективи"], "mechanics": ["Контроль територій", "Колодобудівля"]},
]
